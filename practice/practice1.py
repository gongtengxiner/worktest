...
class practice1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Practice1")
        ...
        self.settings = Qt.QSettings("GNU Radio", "practice1")
        ...
        self.gain = gain = 30
        self.center_freq = center_freq = 2.421e9
        ...
        self.analog_random_source_x_0_0 = blocks.vector_source_b(map(int, numpy.random.randint(0, 2, 1000)), True)
...
def main(top_block_cls=practice1, options=None):
