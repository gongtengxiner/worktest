...
class practice3(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Practice3")
        ...
        self.settings = Qt.QSettings("GNU Radio", "practice3")
...
def main(top_block_cls=practice3, options=None):
